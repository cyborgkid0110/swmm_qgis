.. table:: Data and Data Structure for Hydraulic Modeling
   ...
   |                        | Orifices and flow regulators (location, dimensions, discharge coefficients). | Point vector (Shapefile) with attributes | Restricts or regulates flow within the drainage network. |
   +------------------------+------------------------------------------+------------------------------------------+------------------------------------------------+
